 ...
 */
public class HybridPlaneCreationFrame extends JFrame
{
	private final String path = "src/resources/vehicles/hybrid_plane/";
	 ...
	 */
	public HybridPlaneCreationFrame()
	{
		super("Hybrid Plane Vehicle Creation");
