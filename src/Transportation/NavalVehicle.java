...
public abstract class NavalVehicle extends Vehicle
{
	...
	/**
	 * Method retrieving if the vehicle vehicle's direction with or against the wind.  
	 * @return boolean value of that contains the answer if the vehicle is with or against the direction of the wind.
	 */
